...
<img width="1917" height="866" alt="image (2)" src="https://github.com/user-attachments/assets/e9792f7d-660a-4e66-93de-b5915ea89359" />

[그림 6-1] 메인 화면

메인화면 상단에는 탑바가 있다. 이 탑바는 거의 모든 화면 위에서 표시되는 것으로, 왼쪽에는 홈페이지 로고가 있고, 가운데에는 주요 기능들인 ‘문제’, ‘게시판’, ’스터디 그룹’, ‘코드 IDE 바로가기’ 4가지가 있다. 초기에는 로그인과 회원가입이 있으며, 로그인 했을 경우에는 마이페이지와 로그아웃 버튼으로 바뀐다. 주간 순위가 떠 있으며, 문제 조회수, 평판, 코드리뷰 3가지 항목의 일주일 기준 주간 조회수 순위를 5개 볼 수 있다. 또한, 문제 조회수를 클릭할 경우 해당 문제의 상세 화면으로 이동이 되며, 평판 순위의 경우 해당 유저의 마이페이지로 이동이 된다.
...
<img width="1919" height="903" alt="register" src="https://github.com/user-attachments/assets/af84b61b-da44-4d16-acb8-1a374b6ef347" />

[그림 6-3] 회원가입 화면

회원가입은 일반 학습자 혹은 강사로 신청이 가능하다. 공통적으로는 이메일, 비밀번호, 전화번호, 이름, 닉네임을 입력하는 칸이 있다. 강사의 경우 포토폴리오 URL, 포토폴리오 파일을 올리는 칸이 추가되며, 둘 중 하나 이상만 입력하면 된다. 아래에 약관 동의 박스가 2개 있으며, 모든 회원가입 조건을 만족할 경우 가입하기 버튼이 활성화되어 가입하기 버튼을 누르면 정상적으로 가입이 된다.
...
<img width="1919" height="855" alt="image (3)" src="https://github.com/user-attachments/assets/e0d21312-d930-4e2b-aed4-9097e162f913" />

[그림 6-7] 문제 목록

위 화면에는 사이트에 등록된 문제들이 모두 표시되는 화면이다. 기본적으로 최신순으로 되어 있지만, 난이도순, 조회순, 선호언어 순 등으로도 순서를 바꿀 수 있다. 문제 제목을 누르면 내용이 펼쳐져 사용자가 더 내용을 확인 할 수 있으며, 상세페이지 혹은 바로 코드를 작성할 수 있는 페이지로 넘어갈 수 있다. 여기서 회원이 로그인 한 상태로 접속한 경우 자신이 푼 문제가 기록에 남아 있으며, 기록 필터를 통해 자신이 푼 문제들을 조건별로 필터링해 확인 할 수 있다. 그리고 태그 기능이 있으며, 이 태그를 누르면 해당 문제들이 필터링되어 볼 수 있다. 또한 관리자 또는 강사의 경우 오른쪽 위 문제 추가 버튼이 보이며 문제 추가 화면으로 넘어갈 수 있다.

<img width="1918" height="865" alt="image (4)" src="https://github.com/user-attachments/assets/32ba84f4-9328-4b77-81ed-fc18b755b9d8" />

[그림 6-8] 문제 상세페이지

상단에는 문제 제목과 문제 번호가 있다. 아래에는 난이도, 조회수, 등록일, 작성자, 푼 사람, 정답률, 시간 제한, 메모리 제한이 적혀 있다.  아래에는 문제 설명이 있으며, 옆에는 태그가 있다. 태그를 누르면 태그와 관련된 문제들을 문제 목록 화면에서 볼 수 있다. 이후에 입출력, 입출력 예제들, 힌트, 출처, 제약 조건이 적혀 있다. 여기서 바로 문제를 풀 수 있고, 이미 풀어본 적이 있다면 내 코드 보기로 넘어가서 그동안 자신이 푼 코드를 볼 수 있다. 버튼들이 여러개 있으며, 로그인한 회원이 제출을 한번이라도 했을 경우 제출한 기록 보기 버튼이 보이고, 강사나 관리자의 경우 문제 수정이 가능하다. 각각의 버튼을 누르면 추후에 설명할 각각의 화면으로 이동이 된다.

<img width="1918" height="860" alt="image (5)" src="https://github.com/user-attachments/assets/bd66ccea-fcb8-461a-a91b-aa79b3eb3620" />

[그림 6-9] 문제 추가(1)

<img width="1919" height="857" alt="image (6)" src="https://github.com/user-attachments/assets/068f5728-9e5f-4cc5-b2d9-21100f35409c" />

[그림 6-10] 문제 추가(2)

문제 추가 화면은 관리자 혹은 강사만 들어 갈 수 있으며, 문제 풀이 및 채점에 필요한 기초적인 정보들을 입력하는 화면이다. 제목, 난이도, 태그, 요약, 설명, 입출력 예시, 테스트케이스 파일, 출처 및 힌트를 작성할 수 있는 칸들로 구성되어 있다. 모든 필수 내용을 입력하면 문제 등록 버튼이 활성화되어 추가할 수 있다.

<img width="1919" height="863" alt="image (7)" src="https://github.com/user-attachments/assets/70cc80f2-d538-4342-9cf3-27d0b47ddcdc" />

[그림 6-11] 문제 풀기

문제 푸는 화면은 왼쪽에 문제 상세 내용 중 몇 가지 필수 사항들만 표시가 된다. 오른쪽에는 코드를 작성할 수 있는 화면이 있으며, 아래에는 임시저장, 임시저장 불러오기, 제출하기 버튼이 있다. 언어는 파이썬, C++, Java 3가지 중 하나를 고를 수 있으며, 폰트 크기 또한 조정이 가능하다. 실행의 경우 실행 입력값에 값을 적여야지만 가능하다.

<img width="1915" height="856" alt="image (8)" src="https://github.com/user-attachments/assets/13e2dc48-c484-4407-93f4-ea6af20b08cb" />

[그림 6-12] 제출 결과

상단에 정답 여부와 채점 진행률이 뜨며, 통과/실패한 테스트, 실행 시간, 메모리 사용량, 채점 ID, 최종결과가 뜬다. 아래로는 내 제출 기록이 함께 뜨며, 설정 언어, 메모리, 실행시간, 제출일, 결과까지 함께 표시된다.


<img width="1915" height="854" alt="image (10)" src="https://github.com/user-attachments/assets/6fc6f637-deb5-4c72-8a6f-ac2b9874c490" />

[그림 6-13] 코드 분석

코드 분석 화면에서는 자신이 제출한 풀이가 뜨며, 아래에는 제출 정보와 테스트 케이스 결과가 있다. 오른쪽 화면에서는 복잡도 분석과 플로우 차트 기능이 있는데, 이는 AI 기능을 활용해서 사용자의 코드를 분석해 결과를 띄워주는 기능이다.

<img width="1298" height="916" alt="flowchart" src="https://github.com/user-attachments/assets/a4badf73-9d18-48ef-85cf-bd57c780dda3" />

[그림 6-14] 플로우 차트

플로우 차트의 경우도 한 눈에 보기 좋게 사용자의 코드를 분석해 흐름을 보여준다.

<img width="1919" height="856" alt="image (11)" src="https://github.com/user-attachments/assets/fdce79e0-c520-4686-b29a-dc249439df95" />

[그림 6-15] 공유된 풀이 목록

공유된 풀이 목록은 사용자 자신이 제출한 코드들 중 공유하기 버튼을 눌렀을 때 이곳에 추가되는 기능으로, UnIDE 회원이라면 누구나 자유롭게 볼 수 있다.

<img width="1919" height="871" alt="image (13)" src="https://github.com/user-attachments/assets/078ea4ed-f16f-4919-a11a-9c9c1980ed6a" />

[그림 6-16] 코드 리뷰

공유된 풀이 목록에서 상세 보기를 누를 경유 코드 리뷰를 남길 수 있으며, 사용자의 제출된 코드 옆 + 표시를 누르면 작성할 수 있다. 작성이 완료되면 화면에 보이는 것 처럼 리뷰가 달리며, 댓글 또한 작성할 수 있다. 좋아요를 누를 수 있으며, 자신이 작성한 글이라면 수정 혹은 삭제가 가능하다.

<img width="1919" height="864" alt="image (12)" src="https://github.com/user-attachments/assets/fd84a898-d66f-475d-b5a6-294715868752" />

[그림 6-17] 토론 게시판

토론 게시판은 크게 4가지로 나뉜다. 일반, 강의, 홍보, 오타 가 있으며, 로그인 한 회원만 접속이 가능하다. 게시판 번호, 게시글 제목, 작성자, 추천수, 작성일이 표시되며, 제목 검색 또한 가능하다. 최신순, 추천순으로 조회가 가능하다.

<img width="1919" height="871" alt="image (13)" src="https://github.com/user-attachments/assets/f6cd1d24-4e60-4541-a35a-ac049ea79c2e" />

[그림 6-18] 토론 게시판 상세보기

토론 게시판 글을 누를 때 나오는 화면이다. 게시글 제목, 내용, 투표를 추가할 경우 투표까지 뜬다. 한 회원당 투표는 1번만 가능하며, 취소가 불가능하다. 코드 리뷰 게시판과 동일하게 댓글 작성이 가능하며, 추천, 수정, 삭제가 가능하다. 신고 또한 가능하며, 신고 기능은 추후에 설명이 있다. 또한, 여기서 게시글이나 댓글 작성자를 누르면 해당 회원의 마이페이지로 이동된다.

<img width="1919" height="859" alt="image (14)" src="https://github.com/user-attachments/assets/6ceacadf-bfe4-434d-b2fa-6cf00017f738" />

[그림 6-19] 토론 게시글 작성

카테고리 선택, 제목, 내용을 작성하는 칸이 있고, 투표를 원할 경우 투표 생성을 통해 직접 만들 수 있다. 또한, 이미지 URL 기능을 제공해 이미지 링크를 걸 수 있다. 모든 필수 내용을 입력하면 등록 할 수 있다.

<img width="1918" height="906" alt="QnAlist" src="https://github.com/user-attachments/assets/6f42c28c-c0cf-42d4-9b67-6c634d8c3e60" />

[그림 6-20] QnA 게시판

QnA게시판 또한 존재한다. QnA게시판의 경우 문제를 가지고 사용자들이 질문을 남기는 게시판이다. 게시판 아이디, 문제번호, 작성 제목, 댓글수, 작성자, 작성일이 표시되며, 제목이나 문제 번호로 검색을 할 수 있다. 번호순, 최신순으로 조회가 가능하다.

QnA 게시글 상세는 [그림 6-17] 토론 게시판 상세보기와 동일하다.

<img width="1919" height="859" alt="image (14)" src="https://github.com/user-attachments/assets/e8fbcff9-b658-4c31-9df1-f76ad6ec4dc9" />

[그림 6-21] QnA 게시글 작성

문제 선택, 제목, 내용을 작성하는 칸이 있고, 투표를 원할 경우 투표 생성을 통해 직접 만들 수 있다. 또한, 이미지 URL 기능을 제공해 이미지 링크를 걸 수 있다. 모든 필수 내용을 입력하면 등록 할 수 있다.

<img width="547" height="335" alt="image (16)" src="https://github.com/user-attachments/assets/0d3cb47d-90e5-4e70-92b3-f99dfcd37c84" />

[그림 6-22] 컨텐츠 신고

신고 버튼을 누르면 나오는 화면으로, 신고 유형을 선택해 신고하기를 누르면 신고 접수가 된다. 추후 신고 내역은 관리자만이 확인할 수 있다.

<img width="1919" height="864" alt="image (17)" src="https://github.com/user-attachments/assets/d1e90ee0-461b-4f27-be49-6393d5c8329d" />

[그림 6-23] 스터디 그룹 

스터디 그룹 조회 화면이다. 자신이 소속된 스터디 그룹이 있을경우 상단에 뜨며, 아래에는 현재 사이트에 만들어진 스터디 그룹들이 뜬다. 그룹명 검색으로 스터디 그룹 검색 또한 가능하다.

<img width="1913" height="900" alt="studygroupadd" src="https://github.com/user-attachments/assets/166b4b8c-65ba-48e4-bcd1-a14d3432be7e" />

[그림 6-24] 스터디 그룹 생성

스터디 그룹은 회원 누구든 생성이 가능하며, 그룹명, 그룹 설명, 최대 인원만 설정을 맞추면 즉시 생성이 된다.

<img width="1919" height="859" alt="image (19)" src="https://github.com/user-attachments/assets/9d920b84-2653-4ecf-9c51-27ac225e6d6b" />

[그림 6-25] 스터디 그룹 메인 화면

자신이 가입한 스터디 그룹 화면에 들어오면 보이는 화면이다.  왼쪽에는 스터디 그룹 정보와 회원들이 보이며, 회원들을 누르면 각 회원의 마이페이지를 볼 수 있다. 문제 목록, 토론 게시판, 활동 기록 3가지가 있다. 먼저, 문제 목록의 경우 스터디 그룹장만 만들 수 있으며, 제출기한을 설정하여 스터디 그룹 그룹원들이 직접 문제를 풀 수 있도록 그룹 활동을 하는 기능이다.

<img width="1916" height="855" alt="image (18)" src="https://github.com/user-attachments/assets/9bfbfe82-9043-4030-a75f-1a9b0d32161d" />

[그림 6-26] 스터디 그룹 문제 리스트 생성

문제 리스트를 생성할 수 있는 화면이다. 문제 리스트 제목, 문제 추가, 선택된 문제들, 마감일이 보이며, 문제 추가를 누를 경우 사이트에 등록된 모든 문제들이 표시되며, 직접 선택해서 추가하고 삭제하면 된다. 저장하기를 누르면 생성에 성공되며 화면이 닫힌다.

<img width="1919" height="858" alt="image (20)" src="https://github.com/user-attachments/assets/1e75a740-e5f9-464d-adf1-6f39583b7382" />

[그림 6-27] 스터디 그룹 토론 게시판

스터디 그룹 내에 있는 토론 게시판으로, 기존의 토론 게시판과 다르게 아주 기본적인 기능만 들어 가 있다.  스터디 그룹원들끼리만 사용이 가능하며, 간단하게 제목과 글만 작성이 가능하며, 댓글 작성이 가능하고 수정과 삭제가 가능하다.

<img width="1915" height="863" alt="image (21)" src="https://github.com/user-attachments/assets/48294533-da2c-4e72-8360-0d98152a1183" />

[그림 6-28] 스터디 그룹 활동 기록

스터디 그룹 화면에 활동 기록 탭이 있으며, 누르면 그동안의 기록이 최신순으로 뜬다. 기록으로 남아 있는 내용은 스터디 그룹 생성일, 멤버 추가, 리스트 추가 및 수정, 토론일, 목표달성일 등이 있다.

<img width="1919" height="862" alt="image (22)" src="https://github.com/user-attachments/assets/ab671fcc-edd4-4ea6-b8a0-e040f9841163" />

[그림 6-29] 스터디 그룹 관리

스터디 그룹장만이 접속 가능한 화면이며, 스터디 그룹 정보 수정, 멤버 관리를 통한 강퇴기능, 스터디 그룹 문제 목록 관리가 가능하며 여기서 문제 목록을 수정하거나 삭제할 수 있다. 또한 스터디 그룹장 혼자만 남아 있을 경우 스터디 그룹을 삭제할 수 있다.

<img width="1919" height="865" alt="image (23)" src="https://github.com/user-attachments/assets/c7d948d6-0ab9-4dd0-8a1a-9d4e819710ac" />

[그림 6-30] IDE 화면

로그인한 회원만이 접속 가능하며, 문제 풀기 화면과 비슷하지만 여기서는 문제를 직접 선택해서 풀 수 있는 화면이다. 나머지 버튼들의 기능은 기존 문제 풀기 화면과 동일하다.

<img width="843" height="752" alt="image (24)" src="https://github.com/user-attachments/assets/21ca6391-1173-4eae-abd5-f913a66c4837" />

[그림 6-31] 마이페이지

로그인한 회원 자신에게 보이는 마이페이지이다. 자신의 아바타, 닉네임, 선호 언어가 상단에 있으며. 푼 문제 수, 최근 춘 문제 수, 정답률, 내가 푼 문제, 평판 점수, 최근 제출 문제, 학습 목표가 표시되어 있다.

<img width="1919" height="862" alt="image (25)" src="https://github.com/user-attachments/assets/3bacbc0b-2839-440b-8cfd-266b145e939b" />

[그림 6-32] 마이페이지 수정 화면(1)

마이페이지 수정 화면으로, 닉네임, 소개글, 선호 언어, 학습 목표를 수정할 수 있다.

<img width="1919" height="864" alt="image (26)" src="https://github.com/user-attachments/assets/b138dc05-0ca1-432d-820f-e4c34dd7adb6" />

[그림 6-33] 마이페이지 수정 화면(2)

학습 알림을 설정하여 원하는 요일과 시간에 알림을 받을 수 있으며, 다크 모드를 눌러서 다크 모드를 사용할 수 있고, 마이페이지 비공개 버튼을 눌러 자신의 마이페이지를 다른 사람들에게 보이지 않게 가릴 수 있다. 또한 회원탈퇴 기능이 이 곳에 있다.

<img width="1918" height="866" alt="image (27)" src="https://github.com/user-attachments/assets/86cc50f5-3c99-41fc-be70-14541d3eb7da" />

[그림 6-34] 관리자 페이지

관리자만이 접속할 수 있는 페이지로, 크게 3가지로 나뉜다. 먼저, 유저 관리에는 현재 웹사이트에 있는 모든 유저들의 정보가 있으며, 유저 정보보기를 누르면 해당 유저의 정보가 토글로 표시된다. 블랙리스트를 누를 경우 해당 회원은 블랙리스트에 들어가지며 로그인 및 회원가입이 제한된다. 유저 제거를 하면 유저가 블랙리스트에 들어가지 않은 채로 삭제가 된다. 또한, 역할 변경 버튼을 눌러 해당 회원의 역할을 바꿀 수 있다. 아래의 강사 신청 목록은 회원이 강사 신청을 할 때 들어가지는 화면으로, 강사 정보 보기를 누르면 해당 강사의 정보, 강사가 남긴 포토폴리오 url 및 파일이 보이며, 다운하기를 누르면 해당 파일을 다운 받아 볼 수 있다. 그리고 강사 승인 혹은 반려가 가능하며, 결과가 해당 회원에게 이메일로 발송된다.

<img width="1919" height="860" alt="image (28)" src="https://github.com/user-attachments/assets/4f9a3dcc-ff7c-4e1d-9afe-903319ca2a8e" />

[그림 6-35] 신고 관리

회원들이 게시글을 보며 신고한 목록이 뜨는 화면이다. 신고 대상, 신고 대상 작성자, 신고자, 신고일이 뜨며, 누르면 신고 접수 여부를 결정할 수 있다. 신고 후 조치 결과는 해당 회원의 이메일로 발송된다. 또한 블랙리스트 내역에는 현재 블랙리스트에 떠 있는 회원들의 정보가 뜬다.

<img width="1919" height="861" alt="image (29)" src="https://github.com/user-attachments/assets/9dd844dc-6390-4b9b-8454-57798db8573d" />

[그림 6-36] 문제 관리

문제 관리는 크게 3가지로 나뉜다. 먼저, 승인 대기 중인 문제의 경우 웹사이트에서 강사 혹은 관리자가 제출한 문제가 표시되어 있고, 내가 작성한 문제는 현재 접속한 계정 주인이 작성한 문제 목록이 뜬다. 전체 문제 관리는 이 사이트의 있는 모든 문제 목록이 뜬다. 문제 상세 보기를 누르면 문제 정보가 아래로 토글 되어 나오고, 테스트케이스 다운로드를 누르면 문제 제출 혹은 수정 때 올린 테스트 케이스 파일이 다운이 되어진다. 문제 등록은 승인 대기 중인 문제에 사용이 가능하며, 문제 삭제를 누르면 현재 등록된 문제를 삭제할 수 있다.

<img width="721" height="284" alt="image (30)" src="https://github.com/user-attachments/assets/ef5def4a-5f8a-4211-9775-1e5ab5adad00" />

[그림 6-37] 코딩 성향 분석

사용자가 제출한 문제들을 바탕으로  AI가 분석해서 결과를 알려주는 화면으로, 회원이 문제를 10회 이상 맞출 때마다 새롭게 갱신되어 분석 결과를 보여준다. 코드의 전반적인 분석, 강점, 약점, 개선 제안을 보여준다.
