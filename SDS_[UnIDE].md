...
<img width="869" height="614" alt="image (1)" src="https://github.com/user-attachments/assets/24fecf0e-fff0-45b7-a10e-6786ba8c5875" />

[그림 6-1] 메인 화면

메인화면 상단에는 탑바가 있다. 이 탑바는 거의 모든 화면 위에서 표시되는 것으로, 왼쪽에는 홈페이지 로고가 있고, 가운데에는 주요 기능들인 ‘문제’, ‘게시판’, ’스터디 그룹’ 3가지가 있다. 중간에 라이트 모드와 다크 모드를 바꿀 수 있는 토글 버튼이 있으며, 초기에는 로그인과 회원가입이 있으며, 로그인 했을 경우에는 마이페이지와 로그아웃 버튼으로 바뀐다. 주간 순위가 떠 있으며, 문제 조회수, 평판, 코드리뷰 3가지 항목의 일주일 기준 주간 조회수 순위를 5개 볼 수 있다.

<img width="1915" height="900" alt="image (2)" src="https://github.com/user-attachments/assets/c21fa4ca-fee6-4589-a410-39a4ccf488c7" />

[그림 6-2] 로그인 화면

로그인 화면에는 자신이 회원가입 할 때 입력했던 이메일과 비밀번호를 입력하는 칸이 있다. 아래의 로그인 유지 버튼을 누를 경우 회원은 로그인을 일정 기간동안 유지를 할 수 있게 된다. 아래에는 비밀번호를 변경하거나 회원가입을 바로 할 수 있는 기능 또한 존재하며, 아래의 소셜 로그인은 소셜 계정을 가지고 로그인을 할 수 있다. 만약 회원가입하지 않은 사람이 소셜로그인을 시도할 경우, 회원가입 화면으로 넘어가진다.

<img width="1919" height="866" alt="image (3)" src="https://github.com/user-attachments/assets/7acde625-9199-42d0-819d-3e3f34e009c4" />

[그림 6-3] 회원가입 화면

회원가입에서는 이메일, 비밀번호, 전화번호, 이름, 닉네임을 입력하는 칸이 있다. 아래에 약관 동의 박스가 2개 있으며, 모든 회원가입 조건을 만족할 경우 가입하기 버튼이 활성화되어 가입하기 버튼을 누르면 정상적으로 가입이 된다.

<img width="1919" height="869" alt="image (4)" src="https://github.com/user-attachments/assets/2eae0c17-5439-4b47-ac1e-3929ce729ce3" />

[그림 6-4] 비밀번호 재설정 화면

회원가입 창에서 비밀번호를 까먹은 경우 이메일을 인증받아 다시 비밀번호를 설정받아 로그인을 시도할 수 있는 화면이다. 이매일을 입력하면 입력된 이메일에 아래와 같은 인증 코드가 날아가며, 다시 돌아와서 인증 번호를 입력하고 확인하기를 누르면 재설정 화면으로 넘어가진다.

<img width="1919" height="863" alt="image (6)" src="https://github.com/user-attachments/assets/017360b0-2091-4a40-8d26-cc877ad05ae5" />

[그림 6-5] 비밀번호 재설정 두번째 화면

새 비밀번호와 비밀번호 확인란의 두 기입란이 있으며, 변경하기를 누르면 정상적으로 변경이 된다.

<img width="704" height="493" alt="6-6_마이페이지" src="https://github.com/user-attachments/assets/bf1adf62-2d26-45c4-89ee-20a343f529a0" />


[그림 6-6] 마이페이지 개인정보

로그인 한 사용자가 접속 가능한 페이지이다. 크게 5가지 항목으로 나뉘며, 나의 정보를 확인할 수 있는 페이지, 내가 푼 문제 관련으로 확인 할 수 있는 페이지, 스터디 그룹 페이지, 개인 학습 대시보드, 알림창이 있다. 나의 정보에는 내 정보, 평판 점수, 내가 작성한 커뮤니티 글들을 확인 할 수 있다. 스터디 그룹의 경우 자신이 가입한 스터디 그룹이 보이며, 추후에 나올 [그림 6-23] 스터디 그룹 메인화면 화면에서 나의 스터디 그룹 화면만이 보여 바로 접속할 수 있도록 만들었다. 알림의 경우 시스템이 알려줘야 할 내용들이 이곳에 최신순으로 표시된다. 강사 신청하기 버튼은 일반 회원에게만 보이며, 강사 자격을 신청할 수 있는 기능이다. 아래의 관리자 페이지는 관리자가 마이페이지에 접속 했을 때에만 보이며, 추후에 나올 [그림 6- 33] 관리자 페이지에 접속할 수 있게 한다.

<img width="1917" height="891" alt="image (8)" src="https://github.com/user-attachments/assets/044dce5d-e647-4ea7-8518-32044c4c1c44" />

[그림 6-7] 마이페이지 문제 관련 정보

문제 버튼을 눌렀을때 나오는 화면으로, 자신이 푼 문제들이 보이며 전체적인 통계가 보인다.

<img width="845" height="594" alt="image (9)" src="https://github.com/user-attachments/assets/ed302a19-1af4-4b6c-80c3-6fb2aa3b0e0d" />

[그림 6-8] 강사 신청

일반 회원의 경우, 강사 자격을 신청할 수 있다. 강사가 되기 위해서는 본인의 포토폴리오 혹은 포토폴리오가 이미 업로드 되어 있는 링크를 제공할 수 있다. 제출한 뒤 추후에 관리자 페이지에서 관리자들이 관리를 한다.


<img width="703" height="491" alt="6-9_개인학습_대시보드" src="https://github.com/user-attachments/assets/fb4c9540-a5a1-48e7-aec6-c8ea08d2c0cd" />

[그림 6-9] 개인 학습 대시보드

사용자의 학습 성과(풀이 수, 정답률, 스트릭 등)를 요약 카드와 그래프로 제공하는 기능, '취약 개념 분석' 결과를 기반으로 사용자에게 풀어볼 문제나 수강할 강좌를 추천하는 기능, 사용자의 일별 학습 활동(문제 풀이)을 기준으로 연속 학습일을 계산하고, 달력/배지 형태로 시각화하는 기능
이 있는 대시보드이다.


<img width="1917" height="906" alt="image (10)" src="https://github.com/user-attachments/assets/e8c70d90-0bb4-4339-a0b6-a74b8b380e13" />

[그림 6-10] 문제 목록

위 화면에는 사이트에 등록된 문제들이 모두 표시되는 화면이다. 기본적으로 최신순으로 되어 있지만, 난이도순, 조회순, 선호언어 순 등으로도 순서를 바꿀 수 있다. 문제 제목을 누르면 내용이 펼쳐져 사용자가 더 내용을 확인 할 수 있으며, 상세페이지 혹은 바로 코드를 작성할 수 있는 페이지로 넘어갈 수 있다. 여기서 회원이 로그인 한 상태로 접속한 경우 자신이 푼 문제가 기록에 남아 있으며, 기록 필터를 통해 자신이 푼 문제들을 조건별로 필터링해 확인 할 수 있다. 또한 관리자 또는 강사의 경우 오른쪽 위 문제 추가 버튼이 보이며 문제 추가 화면으로 넘어갈 수 있다.

<img width="1274" height="716" alt="image (11)" src="https://github.com/user-attachments/assets/540f6934-557e-48ac-aaec-cc3a4ddc54ed" />

[그림 6-11] 문제 상세페이지

가장 상단에는 문제 제목과 문제 번호가 있다. 아래에는 난이도, 조회수, 등록일, 작성자, 춘 사람, 정답률, 시간 제한, 메모리 제한, 사용가능 언어가 적혀 있다. 여기서 작성자를 누를 경우 작성자의 마이페이지로 연결이 된다. 또한 자신이 풀어본 문제일 경우, 도전횟수와 정답률이 뜨며, 한번이라도 맞췄으면 초록색, 맞추지 못했으면 빨간색으로 뜬다.

아래에는 문제 설명이 있으며, 옆에는 태그가 있다. 태그를 누르면 태그와 관련된 문제들을 문제 목록 화면에서 볼 수 있다. 이후에 입출력, 입출력 예제들, 힌트, 출처, 제약조건이 적혀 있다. 여기서 바로 문제를 풀 수 있고, 이미 풀어본 적이 있다면 내 코드 보기로 넘어가서 그동안 자신이 푼 코드를 볼 수 있다.

<img width="1271" height="700" alt="image (12)" src="https://github.com/user-attachments/assets/c2cb2fe1-63d8-4334-ac9b-27b77fc69b4f" />

[그림 6-12] 문제 추가 

문제 추가 화면은 관리자 혹은 강사만 들어 갈 수 있으며, 문제 풀이 및 채점에 필요한 기초적인 정보들을 입력하는 화면이다. 제목, 난이도, 태그, 요약, 문제, 입풀력 형식, 입출력 예시, 테스트 코드, 제한사항, 출처 및 힌트를 작성할 수 있는 칸들로 구성되어 있다. 모든 필수 내용을 입력하면 문제 추가 버튼이 활성화되어 추가할 수 있다.

<img width="706" height="498" alt="image (13)" src="https://github.com/user-attachments/assets/ac9203b2-7fa8-4008-9110-35082e7adc49" />

[그림 6-13] 문제 풀기

문제 푸는 화면은 왼쪽에 문제 상세 내용 중 몇 가지 필수 사항들만 표시가 된다. 오른쪽에는 코드를 작성할 수 있는 화면이 있으며, 아래에는 임시저장, 임시저장 불러오기, 제출하기 버튼이 있다.

<img width="527" height="372" alt="image (14)" src="https://github.com/user-attachments/assets/0ef54237-041e-4724-873c-28c947e31e1b" />

[그림 6-14] 내 코드 보기

문제 제출을 누른 뒤, 혹은 문제 상세 화면에서 내 풀이 보기 버튼을 누르면 나오는 화면으로, 그동안 자신이 제출한 문제들이 최신순으로 떠 있다. 위에 비교하기 버튼이 있는데, 이는 결과가 나온 코드들 중 2개를 선택해서 한번에 비교를 할 수 있게 해주는 기능이다.

<img width="1313" height="880" alt="image (15)" src="https://github.com/user-attachments/assets/f8d560b1-8a89-4fec-af26-68ab0dc36e55" />

[그림 6-15] 코드 분석 메인 화면

코드 분석 화면은 크게 2개의 화면으로 나뉘어지며, 양쪽의 크기를 조절할 수 있다. 오른쪽 상단에는 코드를 공개 혹은 비공개로 바꿀 수 있는 버튼이 있고, 옆에는 바로 코드 리뷰로 넘어갈 수 있는 버튼이 있다. 중심 화면에 왼쪽에는 자신이 제출한 문제가 보여지며, 자신이 작성한 코드가 있다. 자신이 틀린 문제일 경우, 아래의 테스트케이스 결과 화면이 나오며, 기대한 출력값들과 자신의 코드로 나온 출력값들이 표시된다. 또한, 사용자가 제출한 코드 중에 비효율적으로 분석된 코드가 있다면 이 또한 아래에 표시가 된다.

<img width="1298" height="863" alt="image (16)" src="https://github.com/user-attachments/assets/898f0337-2d78-4dd5-b193-7c0489e7f762" />

[그림 6-16] 코드 개선 가이드

사용자의 코드를 분석한 뒤 개선된 코드와 사유까지 분석해서 화면에 띄워준다.

오른쪽 화면은 분석 파트로, 사용자는 접거나 펼칠 수 있으며, 왼쪽 화면과 공간 조절 또한 가능하다. 분석파트는 크게 나뉘며, 먼저 성능 분석에서는 사용자의 코드로 돌린 테스트 케이스 그래프의 실행 시간과 메모리 사용량이 보이며, 마우스를 올리면 가로축 내용이 상세하게 보인다. 또한 아래에 복잡도 분석으로,  테스트 케이스별 (입력 크기, 실행 시간) 데이터를 분석해 가장 적합도가 높은 모델(예: 'O(N²)')과 신뢰도(예: R²=0.95)를 화면에 띄워주는 기능이다.

<img width="1301" height="873" alt="image (17)" src="https://github.com/user-attachments/assets/08e998be-64c1-4fe7-accc-b1ebc3321d7f" />

[그림 6-17] 프로파일링 분석

두번째로 프로파일링은 라인별 실행 시간과 호출 횟수를 표시해주는데, 시간이 많이 소요된 라인(병목 구간)을 붉은색 계열의 히트맵으로 강조 표시한다. 사용자가 히트맵이 표시된 라인을 클릭하면, 해당 라인의 상세 정보가 팝업으로 표시된다. 또한 사용된 메모리가 아래에 표시된다.

<img width="1319" height="872" alt="image (18)" src="https://github.com/user-attachments/assets/e16d8739-2a93-42ec-b95f-e5f64af981a3" />

[그림 6-18] 플로우차트

마지막으로 플로우차트는 사용자가 작성한 코드를 분석하여 제어 흐름(if, for, while)을 플로우 차트로 자동 생성하는 기능으로, PNG 저장 기능을 통해 이를 직접 저장할 수도 있다.

<img width="815" height="581" alt="image (19)" src="https://github.com/user-attachments/assets/84a18610-6047-4a52-98a1-22b8e50ea73a" />

[그림 6-19] 효율랭킹

효율랭킹에서는 제출한 코드에는 성능 기준(실행 시간, 메모리 사용량)에 따른 종합적인 랭킹을 확인 할 수 있으며, 상위 몇 프로 인지까지 확인이 가능하다.

<img width="816" height="581" alt="image (20)" src="https://github.com/user-attachments/assets/cbdd9581-89cf-4ab9-9744-a578055091eb" />

[그림 6-20] 다른 풀이 조회하기

[그림 6-14] 내 코드 보기와 비슷하나, 사용자명과 제출명, 조회수와 투표수까지 뜬다. 사용자는 최신순 이외의 효율순이나 최상위 풀이를 조회를 할 수 있다.

<img width="845" height="597" alt="image (21)" src="https://github.com/user-attachments/assets/255b3221-0027-48a6-8c1a-285a3b6c1ea5" />

[그림 6-21] 코드 리뷰

코드 리뷰 화면에는 자신이 선택한 풀이의 정보가 간략하게 표시가 되며, 다른 사람들이 남겨둔 리뷰들이 보인다. 본인이 작성한 리뷰의 경우 수정 삭제 버튼이 보이며, 수정 및 삭제가 가능하다.

<img width="828" height="595" alt="image (22)" src="https://github.com/user-attachments/assets/99b53a0e-99b9-4b09-ac46-8bcf4f0ca4c8" />

[그림 6-22] 코드 리뷰 작성 화면 

코드 리뷰 화면에서 작성하기 버튼을 누르면 나오는 화면으로, 내용을 자유롭게 작성 할 수 있으며 코드 블록을 추가해서 작성할 수 있다.

<img width="718" height="513" alt="image (23)" src="https://github.com/user-attachments/assets/68cf6433-1996-4131-a8bd-fb07d3413aeb" />

[그림 6-23] 게시판

게시판은 크게 문제별 QnA 게시판, 토론 게시판 2개로 나뉘어진다. 기본적으로 보이는 게시판은 문제별 QnA 게시판으로, 문제에 관한 질문을 자유롭게 할 수 있는 게시판이다. 검색을 통해 원하는 문제 혹은 질문을 찾을 수 있다. 최신순 이외에도 투표순으로 확인 할 수 있다. 문제와 제목, 작성자, 투표 수, 등록일이 보이며, 제목을 누르면 상세 화면으로 넘어가진다. 작성하기를 누를 경우 [그림 6- ] QnA 글 작성 화면으로 넘어간다.

<img width="772" height="544" alt="image (24)" src="https://github.com/user-attachments/assets/f260efd3-9a48-4a63-bccf-3e75462a2b6f" />

[그림 6-24] QnA 게시판 상세화면

상세화면에는 목록에서 본 내용 이외에도 작성된 내용과 함께 달린 댓글들이 보인다. 내용에는 코드 블록을 추가할 수 있다. 왼쪽에는 투표를 할 수 있는 버튼이 있으며, 누르면 +1이 된다. 댓글에는 작성된 사람의 이름과 내용이 있으며, 익명으로 바꿀 수 있다. 자신이 작성한 QnA 글일 경우 수정 삭제 버튼이 보여 사용이 가능하며, 댓글 또한 마찬가지이다.

<img width="573" height="405" alt="image (25)" src="https://github.com/user-attachments/assets/b364da5d-96fd-4a20-a61f-d1e8f052a181" />

[그림 6-25] QnA 글 생성

문제를 직접 선택한 뒤. 제목과 내용을 작성할 수 있으며, 내용에는 코드 블록을 추가할 수 있다. 태그도 본인이 직접 선택할 수 있다. 작성하기를 누를 경우 작성이 완료되며 다시 QnA 게시글 화면으로 넘어가진다.

<img width="805" height="563" alt="image (26)" src="https://github.com/user-attachments/assets/01a902b8-8210-41a0-88f4-7db04171e09b" />

[그림 6-26] 토론 게시판

토론 게시판은 [그림 6-23] 문제별 QnA 게시판과 크게 다른 부분이 없고, 문제와는 관련 없이 자류롭게 토론을 할 수 있다는 차이점이 있다.

<img width="791" height="553" alt="image (27)" src="https://github.com/user-attachments/assets/c00c2167-9bd7-44c3-8ef1-c1e62b7a4612" />

[그림 6-27] 토론 게시판 상세화면

이 또한 [그림 6-24] QnA 게시판 상세화면와 크게 다를 점이 없으나, 연관된 문제는 존재하지 않고, 여기서는 투표를 추가할 수 있는 차이점이 존재한다.

<img width="719" height="510" alt="image (28)" src="https://github.com/user-attachments/assets/8e34930c-463f-4b99-afdd-edb8b167dd19" />

[그림 6-28] 토론 게시판 글 생성

이 또한 [그림 6-25] QnA 글 생성와 크게 차이나는 부분은 없으나 문제와 상관이 없다는 점과 내용에 투표 기능을 추가할 수 있다는 차이점이 있다.

<img width="495" height="354" alt="image (29)" src="https://github.com/user-attachments/assets/72695c92-c605-43a4-9160-316353acbbc0" />

[그림 6-29] 컨텐츠 신고

코드리뷰, QnA 게시판, 토론 게시판 옆에는 컨텐츠를 신고할 수 있는 버튼이 존재한다. 이 버튼을 누르면 로그인한 사용자는 바로 컨텐츠를 신고할 수 있는 화면이 띄워진다. 신고 제목과 사유를 작성할 수 있으며, 유형은 사용자가 누른 컨텐츠로 자동 등록이 된다. 이후 처리 여부는 사용자에게 메시지 형태로 통보된다.

<img width="578" height="414" alt="image (30)" src="https://github.com/user-attachments/assets/1890b198-7775-4e8e-90dd-0ada82256589" />

[그림 6-30] 스터디 그룹 메인화면

스터디 그룹에 들어오면 먼저 자신이 가입한 스터디 그룹이 있을경우 나의 스터디 그룹 공간이 생기며 자신이 가입한 스터디 그룹들이 보인다. 여기서 접속하기를 누르면 스터디 그룹 메인화면에 접속할 수 있다.

<img width="575" height="407" alt="image (31)" src="https://github.com/user-attachments/assets/df96fcc5-a3de-4857-ab01-68c7c95fadfa" />

[그림 6-31] 스터디 그룹 메인화면 하단

아래로 내리거나 가입한 스터디 그룹이 없을 경우 스터디 그룹을 살펴볼 수 있는 화면이 보인다. 상단엔 스터디그룹을 검색할 수 있는 검색창이 있으며, 스터디 그룹의 이름, 목표, 설명, 정원, 생성일, 목표, 설정된 태그들이 보인다. 가입하기를 누를 경우 회원은 가입을 할 수 있다.

<img width="578" height="404" alt="image (32)" src="https://github.com/user-attachments/assets/366429d4-bb6a-4d9d-9a25-42bf9b8b251c" />

[그림 6-32] 스터디 그룹 생성

스터디 그룹 생성을 할 때에는 그룹명, 그룹 설명, 목표, 인원설정, 태그를 설정할 수 있다. 생성하기를 누르면 생성이 되며 작성한 회원은 자동으로 스터디 그룹장이 된다.

<img width="648" height="458" alt="image (33)" src="https://github.com/user-attachments/assets/2e14e5fe-0944-4908-9320-8806052e58e2" />

[그림 6-33]나의 스터디그룹 메인화면 (문제 목록)

나의 스터디 그룹에 접속하면 가장 첫번째로 보이는 화면으로, 왼쪽에는 그룹명, 설정된 태그들, 그룹설정, 현재목표, 맴버, 그룹장, 그리고 다른 맴버들의 목록이 쭉 있다. 오른쪽에는 크게 3가지의 화면으로 나눌 수 있는데, 문제 목록, 토론 게시판, 활동 기록 3가지가 있다. 기본적으로 보이는 화면은 문제 목록이며, 그룹장이 만든 문제 목록들이 보인다. 목록 제목을 누르면 문제 수와 기한, 제출 문제 수가 있으며, 아래에는 자세한 문제 제목, 제출여부, 제출했으면 제출일을 확인할 수 있다. 여기서 문제 제목을 누르면 [그림 6-10] 문제 상세페이지로 넘어가진다. 여기서 수정 버튼과 그룹 관리 또한 그룹장에게만 보이며, 수정 버튼을 누르면 그룹명, 태그 , 그룹설명, 현재 목표를 변경할 수 있다.

<img width="598" height="424" alt="image (34)" src="https://github.com/user-attachments/assets/0c9ed8bf-31af-4829-a2fc-c1401dec0f07" />

[그림 6-34] 스터디그룹 목록 생성하기

목록 생성의 경우 그룹장만 사용이 가능한 기능으로, 위치는 문제 목록 페이지의 오른쪽 상단에 있으나 그룹장에게만 보이는 버튼으로 있다. 목록명, 설명, 마감일을 설정할 수 있으며, 문제 추가는 시스템에 있는 문제들만 가능하기에 문제 찾기를 누르면 아래와 같은 화면을 만나게 된다.


<img width="597" height="420" alt="image (35)" src="https://github.com/user-attachments/assets/a444b715-7b89-488e-8775-4264b87132a5" />

[그림 6-35] 스터디그룹 문제 찾기

시스템에 등록되어 있는 문제들이 쭉 뜨며, 제목 또는 번호를 입력하여 쉽게 찾을 수 있다. 자유롭게 추가 및 삭제가 가능하며, 기본적으로는 번호 순으로 떠 있다.

<img width="602" height="425" alt="image (36)" src="https://github.com/user-attachments/assets/5e7de08e-5881-4884-9ad9-9452cc39ecf4" />

[그림 6-36] 스터디그룹 토론 게시판

두번째로, 스터디 그룹 맴버들만 이용할 수 있는 토론 게시판이 있다. 누구든지 글 작성이 가능하며, 자유롭게 댓글도 추가할 수 있다. 기본적인 기능은 [그림 6-26] 토른 게시판과 동일하다고 보면 된다.

<img width="601" height="426" alt="image (37)" src="https://github.com/user-attachments/assets/4db1d6d5-5615-4a6d-9c2f-f136b7a0e32f" />

[그림 6-37] 스터디그룹 활동기록

마지막으로, 활동기록에는 그동안 스터디그룹에서 한 일들을 확인 할 수 있다. 활동명과 내용, 활동일이 적혀 있으며, 기록으로 남아 있는 내용은 스터디 그룹 생성일, 맴버 추가, 리스트 추가 및 수정, 토론일, 목표 달성일 등이 있다.

<img width="965" height="681" alt="image (38)" src="https://github.com/user-attachments/assets/f2964929-e322-4e7a-b68b-6c1cb93a8782" />

[그림 6-38] 스터디그룹 관리 

이 화면에서는 스터디장이 맴버들을 강퇴시킬 수 있는 화면이다. 강퇴하기를 누를 경우 사유를 선택해야 하며, 탈퇴를 시키면 강퇴당한 멤버에게 사유와 함께 알림이 간다. 또한 스터디 그룹을 삭제할 수 있는 버튼이 있는데, 이 버튼은 스터디 그룹에 맴버가 그룹장 본인만 있을 때 누를 수 있으며 현재 본인의 스터디 그룹을 삭제하게 해준다.

<img width="599" height="419" alt="image (39)" src="https://github.com/user-attachments/assets/00dd2d00-6688-4f39-8758-b17bc324223d" />

[그림 6-39] 관리자 페이지

관리자 페이지는 관리자가 로그인 한 상태에서 마이페이지에서 접속이 가능하며, 신고 관리, ~~~를 이용할 수 있다.

기본적으로 먼저 보이는 화면은 신고 관리 페이지로, 그동안 사용자들이 컨텐츠 신고 버튼을 누른 컨텐츠들이 최신순으로 떠 있다. 유저명과 신고 시간, 처리 여부, 처리를 했을경우 처리한 관리자명, 사용자가 신고한 컨텐츠 및 신고 사유가 적혀 있다. 처리하기를 누를 경우 아래 그림의 화면이 뜬다.

<img width="602" height="422" alt="image (40)" src="https://github.com/user-attachments/assets/23909394-5f4c-4731-87b9-060bfa2c53dd" />

[그림 6-40]관리자 신고 조치 페이지

관리자는 조치를 선택하고 사유를 작성해야 하며, 제재 유형과 제재 기간을 설정할 수 있다.

<img width="545" height="385" alt="image (41)" src="https://github.com/user-attachments/assets/434e87c8-5694-4b0c-8c5a-b34b497ac4c8" />

[그림 6-41] 강사 등록 처리 화면

[그림 6-39]관리자 페이지에서 띄워진 신고 관리 페이지와 동일하되, 상세 내용으로는 강사 등록을 요청한 유저가 업로드한 포토폴리오와 url이 보여진다. 관리자는 자유롭게 열람이 가능하며, 강사 등록 여부를 결정해서 처리할 수 있다.
