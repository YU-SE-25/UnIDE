...
<img width="570" height="346" alt="image (5)" src="https://github.com/user-attachments/assets/c201565a-f19d-4620-8136-fc011214ad75" />

[그림 6-5] 비밀번호 재설정 이메일 화면

이메일로 받는 재설정 인증 코드 화면으로, 이 번호를 입력하면 된다.

<img width="1919" height="863" alt="image (6)" src="https://github.com/user-attachments/assets/017360b0-2091-4a40-8d26-cc877ad05ae5" />
[그림 6-6] 비밀번호 재설정 두번째 화면

새 비밀번호와 비밀번호 확인란의 두 기입란이 있으며, 변경하기를 누르면 정상적으로 변경이 된다.

<img width="984" height="695" alt="image (7)" src="https://github.com/user-attachments/assets/da92d2e1-b1c3-4a4f-a327-efc66e533a26" />
[그림 6-7] 마이페이지 개인정보

로그인 한 사용자가 접속 가능한 페이지이다. 크게 4가지 항목으로 나뉘며, 나의 정보를 확인할 수 있는 페이지, 내가 푼 문제 관련으로 확인 할 수 있는 페이지, 스터디 그룹 페이지, 알림창이 있다. 나의 정보에는 내 정보, 평판 점수, 내가 작성한 커뮤니티 글들을 확인 할 수 있다. 스터디 그룹의 경우 자신이 가입한 스터디 그룹이 보이며, 추후에 나올 [그림 6- 23] 스터디 그룹 메인화면 화면과 동일하다. 알림의 경우 시스템이 알려줘야 할 내용들이 이곳에 최신순으로 표시된다. 강사 신청하기 버튼은 일반 회원에게만 보이며, 강사 자격을 신청할 수 있는 기능이다. 아래의 관리자 페이지는 관리자가 마이페이지에 접속 했을 때에만 보이며, 추후에 나올 [그림 6- 33] 관리자 페이지에 접속할 수 있게 한다.

<img width="1917" height="891" alt="image (8)" src="https://github.com/user-attachments/assets/044dce5d-e647-4ea7-8518-32044c4c1c44" />
[그림 6-8] 마이페이지 문제 관련 정보
